cp ../../../qxmd .
cp /content/QXMD/util/qxREAD.py /content/QXMD/Examples/02_Adaibatic_MD/01_Water_NVE/analysis/bond-angle/.
cp /content/QXMD/util/qxREAD.py /content/QXMD/Examples/02_Adaibatic_MD/01_Water_NVE/analysis/eng/.
mkdir data
